...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{heatmap_fifa.png}[!h]
    \caption{Heatmap of Spearman Rank Correlation Coefficients}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{heatmap_coil.png}[!h]
    \caption{Heatmap of Spearman Rank Correlation Coefficients}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{heatmap_orl.png}[!h]
    \caption{Heatmap of Spearman Rank Correlation Coefficients}
